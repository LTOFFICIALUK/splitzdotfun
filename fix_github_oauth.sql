...
DROP FUNCTION IF EXISTS update_oauth_verification_and_social_links(text,text,boolean,text,text);

-- Create the function to update both OAuth verification and social links
